package com.github.digital.security.generator.rest;

import com.alibaba.fastjson.JSON;
import com.github.digital.security.common.msg.TableResultResponse;
import com.github.digital.security.generator.service.GeneratorService;
...
public class GeneratorRest {
    ...
    public void code(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"digital-admin-code.zip\"");
